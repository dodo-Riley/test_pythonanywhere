...
# 디렉토리 변경
!cd /home/sjh7397/mysite/model/Real-ESRGAN
...
def test():
    image_path = '/home/sjh7397/mysite/static/input_img/123.jpg' 
    ...
    if (style == "hayao") | (style == "paprika"):
        PRETRAINED_WEIGHT_DIR = '/home/sjh7397/mysite/model/cartoongan/pretrained_weights' # 저장된 pretrained 모델 가중치 파일 경로
        ...
        cv2.imwrite(f'/home/sjh7397/mysite/static/output_img/{style}_{date_string}.png', alpha_output_2)
    
    else : 
        model_dir = f'/home/sjh7397/mysite/model/saved_model/{style}' # 저장한 모델 디렉토리 경로
    ...
    !python inference_realesrgan.py -n RealESRGAN_x4plus_anime_6B \
                                -i /home/sjh7397/mysite/static/output_img/{style}_{date_string}.png \
                                -o /home/sjh7397/mysite/static/output_img
    
    
    return render_template('result.html', style=style, date_string=date_string)
